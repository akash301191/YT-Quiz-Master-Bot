...
def grade_quiz_responses(user_responses):
    ...
    grading_agent = Agent(
        ...
        instructions=[
            ...
            "For short answer, assess whether the user response is factually correct and relevant.",
            "Return the following structured output using only plain Markdown:",
            "- Bullet or numbered feedback per question:",
            "   • Correctness ✅ or ❌",
            "   • Short explanation of why it's correct or not",
            "   • Score in the format Score: X/1",
            "- At the end, give total score in the format: Total Score: X/Y",
            "- Include one short improvement tip for the learner.",
            "✅ Do NOT include any headings (no #, ##, ###, no bolded section titles).",
            "✅ Do NOT include phrases like 'Quiz Evaluation', 'Feedback Summary', or any section headers.",
            "✅ Keep the structure minimal and clean: just question-by-question feedback, total score, and tip."
        ],
        markdown=True,
        add_datetime_to_instructions=False,
    )
